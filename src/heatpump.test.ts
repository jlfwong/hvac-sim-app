...
describe("AirSourceHeatPump", () => {
  const panasonicHeatPump = new AirSourceHeatPump(panasonicRatings);

  describe("cooling", () => {
    describe("exact match deltaT", () => {
      test("max capacity", () => {
        const rating = panasonicHeatPump.getEstimatedPerformanceRating({
          responseNeeded: { type: "cooling", btusPerHour: 47400 },
          insideAirTempF: 80,
          outsideAirTempF: 95,
        });
      ...
      test("min capacity", () => {
        const rating = panasonicHeatPump.getEstimatedPerformanceRating({
          responseNeeded: { type: "cooling", btusPerHour: 13000 },
          insideAirTempF: 80,
          outsideAirTempF: 95,
        });
        expect(rating).toEqual({
      ...
      test("middle capacity", () => {
        const rating = panasonicHeatPump.getEstimatedPerformanceRating({
          responseNeeded: { type: "cooling", btusPerHour: (47400 + 13000) / 2 },
          insideAirTempF: 80,
          outsideAirTempF: 95,
        });
      ...
      test("below min capacity", () => {
        const rating = panasonicHeatPump.getEstimatedPerformanceRating({
          responseNeeded: { type: "cooling", btusPerHour: 10000 },
          insideAirTempF: 80,
          outsideAirTempF: 95,
        });
      ...
      test("above max capacity", () => {
        const rating = panasonicHeatPump.getEstimatedPerformanceRating({
          responseNeeded: { type: "cooling", btusPerHour: 90000 },
          insideAirTempF: 80,
          outsideAirTempF: 95,
        });
    ...
    test.only("elevation de-rating", () => {
      const rating = panasonicHeatPump.getEstimatedPerformanceRating({
        responseNeeded: { type: "cooling", btusPerHour: 90000 },
        insideAirTempF: 80,
        outsideAirTempF: 95,
        elevationInFeet: 5300,
      });

      expect(rating.btusPerHour).toBeCloseTo(38915, 0);

      // Elevation de-rated, down from 2.42
      // expecting cop 2.068453692307692
  ...
  describe("heating", () => {
    describe("exact match deltaT", () => {
      test("max capacity", () => {
        const rating = panasonicHeatPump.getEstimatedPerformanceRating({
          responseNeeded: { type: "heating", btusPerHour: 36876 },
          insideAirTempF: 70,
          outsideAirTempF: 5,
        });
      ...
      test("min capacity", () => {
        const rating = panasonicHeatPump.getEstimatedPerformanceRating({
          responseNeeded: { type: "heating", btusPerHour: 12500 },
          insideAirTempF: 70,
          outsideAirTempF: 5,
        });
    ...
    test("freezing cold", () => {
      ...
      const rating = panasonicHeatPump.getEstimatedPerformanceRating({
        responseNeeded: { type: "heating", btusPerHour: 40000 },
        insideAirTempF: 70,
        outsideAirTempF: -30,
      });
